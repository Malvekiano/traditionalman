...
export default function Home() {
  ...
  const books = [
    ...
    },
    {
      id: 2,
      title: "HOMBRE ALFA",
      subtitle: "Los Secretos para Seducir que los Chicos Alfa no Quieren que Sepas",
    ...
    <main className="bg-black text-white min-h-screen overflow-x-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
        ...
        <SectionTransition>
          <div className="mb-6 sm:mb-10">
            ...
            <div className="bg-zinc-900 p-3 sm:p-4 rounded-md book-content">
              ...
              <ul className="space-y-1 sm:space-y-2 text-gray-300 text-sm sm:text-base">
                <li className="flex justify-between border-b border-gray-700 pb-1">
                  <span>Introducción al libro</span>
                  <span>1</span>
                </li>
                <li className="flex justify-between border-b border-gray-700 pb-1">
            ...
            <div className="bg-zinc-900 p-3 sm:p-4 rounded-md mt-4 sm:mt-6 book-content">
              <h3 className="text-center font-bold mb-3 sm:mb-4 text-base sm:text-lg">Contenido Hombre Alfa</h3>
              <ul className="space-y-1 sm:space-y-2 text-gray-300 text-sm sm:text-base">
                <li className="flex justify-between border-b border-gray-700 pb-1">
                ...
                <li className="flex justify-between border-b border-gray-700 pb-1">
                  <span>¿Qué es lo que las mujeres buscan en un hombre?</span>
                  <span>5</span>
                </li>
                <li className="flex justify-between border-b border-gray-700 pb-1">
                  <span>Las cualidades de un Alfa</span>
                  <span>15</span>
                </li>
                <li className="flex justify-between border-b border-gray-700 pb-1">
                  <span>Comunicación no verbal e imagen</span>
                  <span>30</span>
                </li>
                <li className="flex justify-between border-b border-gray-700 pb-1">
                  <span>Técnicas de aproximación</span>
                  <span>40</span>
                </li>
              </ul>
            </div>
        ...
        <footer className="text-center text-gray-500 text-xs sm:text-sm pb-6 sm:pb-8">
          <p>Hotmart © 2025 - All rights reserved</p>
          <p>2025-04-03T15:44:57.302Z REF.</p>
        </footer>
      </div>
    </main>
  );
